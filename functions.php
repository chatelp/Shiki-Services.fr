...
function zerif_register_widgets() {
  ...
  register_widget('zerif_team_widget');
	...
	$zerif_lite_sidebars = array ( 'sidebar-ourfocus' => 'sidebar-ourfocus', 'sidebar-testimonials' => 'sidebar-testimonials', 'sidebar-ourteam' => 'sidebar-ourteam', 'sidebar-packages' => 'sidebar-packages' );
	...
	foreach ( $zerif_lite_sidebars as $zerif_lite_sidebar ):
		...
		elseif( $zerif_lite_sidebar == 'sidebar-packages' ):

			$zerif_lite_name = __('Packages section widgets', 'zerif-lite');
...
class zerif_ourfocus extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <h3 class="grey-border-bottom"><?php if( !empty($instance['title']) ): echo apply_filters('widget_title', $instance['title']); endif; ?></h3>
            <!-- FOCUS HEADING -->
            ...
            <div class="team-member">
                ...
                <div class="member-details">
					...
					<?php if( !empty($instance['name']) ): ?>
						...
						<h3 class="dark-text grey-border-bottom"><?php echo apply_filters('widget_title', $instance['name']); ?></h3>
