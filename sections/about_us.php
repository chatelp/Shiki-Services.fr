				...
				<li class="skill skill_1">
					...
					<?php
						...
						echo '<div class="skill-count">';
							...
							echo '<img src='.get_template_directory_uri().'/images/number_one@2x.png width="62px" height="62px" alt="Competence 1">';
				...
				<li class="skill skill_2">
					...
					<?php
						...
						echo '<div class="skill-count">';
								...
								echo '<img src='.get_template_directory_uri().'/images/number_two@2x.png width="62px" height="62px" alt="Competence 2">';
				...
				<li class="skill skill_3">
					...
					<?php
						...
						echo '<div class="skill-count">';
							...
							echo '<img src='.get_template_directory_uri().'/images/number_three@2x.png width="62px" height="62px" alt="Competence 3">';
				...
				<li class="skill skill_4">
					...
					<?php
						...
						echo '<div class="skill-count">';
							...
							echo '<img src='.get_template_directory_uri().'/images/number_four@2x.png width="62px" height="62px" alt="Competence 4">';
	...
	<?php
		if(is_active_sidebar( 'sidebar-aboutus' )):
			echo '<div class="our-clients">';
				echo '<h2><span class="section-footer-title">Précédents projets</span></h2>';
			echo '</div>';
