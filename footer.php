...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box">&copy; Shiki Services &amp; <a class="zerif-copyright" href="http://chatel.pm"'.$attribut_new_tab.' rel="nofollow">Pierre Ch&acirc;tel-Innocenti</a>  2016-2017</div>';
