...
( function( $ ) {
  ...
  /************	PACKAGES SECTION ***********************/
	...
	/* show/hide */
	wp.customize( 'zerif_packages_show', function( value ) {
		value.bind( function( to ) {
			if( to != '' ) {
	...
	wp.customize( 'zerif_packages_title', function( value ) {
		value.bind( function( to ) {
			...
			$( 'section.packages .section-header h2' ).text( to );
		} );
	} );
	...
	wp.customize( 'zerif_packages_subtitle', function( value ) {
		value.bind( function( to ) {
			...
			$( 'section.packages .section-header h6' ).text( to );
		} );
	} );

	/* zerif_packages_header */
	wp.customize( 'zerif_packages_header', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'zerif_packages_background', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'zerif_package_title_color', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'zerif_package_text_color', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'zerif_package_price_color', function( value ) {
		value.bind( function( to ) {
